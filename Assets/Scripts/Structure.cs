...
public class StructurePrototype
{
    ...
    public StructurePrototype(string name, string spriteName, string[] buildableTerrain)
    {
        //Let's check if the static dictionnary of all StructurePrototypes is already instantiated
